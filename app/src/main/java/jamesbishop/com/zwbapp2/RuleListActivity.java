package jamesbishop.com.zwbapp2;
 ...
 * {@link RuleListFragment} and the item details
 * (if present) is a {@link RuleDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link RuleListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class RuleListActivity extends Activity
        implements RuleListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.rule_detail_container) != null) {
            ...
            ((RuleListFragment) getFragmentManager()
                    .findFragmentById(R.id.rule_list))
    ...
    /**
     * Callback method from {@link RuleListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(RuleDetailFragment.ARG_ITEM_ID, id);
